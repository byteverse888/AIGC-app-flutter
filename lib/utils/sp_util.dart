...
class AppSpUtil {
  ...
  static final AppSpUtil _singleton = AppSpUtil._();

  factory AppSpUtil() => _singleton;
  ...
  static String likeKey = "likeKey";

  setLikeByPost(String postId,bool value){
    return prefs?.setBool('${likeKey}_$postId', value);
  }

  bool getLikeByPost(String postId){
    return prefs?.getBool('${likeKey}_$postId')??false;
  }
