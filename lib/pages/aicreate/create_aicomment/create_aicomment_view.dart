...
class CreateAICommentPage extends StatefulWidget {
  @override
  _CreateAICommentPageState createState() => _CreateAICommentPageState();
}

class _CreateAICommentPageState extends State<CreateAICommentPage> {
  final logic = Get.find<CreateAICommentLogic>();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: DatabaseService.getPostComments(currentPost.objectId),
