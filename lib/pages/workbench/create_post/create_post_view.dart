...
class _CreatePostPageState extends State<CreatePostPage> {
  final logic = Get.find<CreatePostLogic>();
  ...
  _submit() async {
    ...
    if (!_isLoading && ((_pickImageNum > 0) || _caption.isNotEmpty)) {
      ...
      await DatabaseService.createPost(userid!, '', _caption);
      //if upload image success
      if (true) {
        await DatabaseService.updatePost('111111', {
          "imagesUrl": ["www.image1.com"]
        });
      }
      // Reset data
