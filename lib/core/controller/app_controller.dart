...
class AppController extends GetxController with UpgradeManger {
  ...
  Future _queryClientConfig() async {
    //final map = await Apis.getClientConfig();
    final map = await DatabaseService.getConfigs();
    clientConfigMap.assignAll(map);
    AppLogger.e(clientConfigMap);
    FileUpdate.initConfig(clientConfigMap['coskey']['SecretId'],
        clientConfigMap['coskey']['SecretKey'],
        clientConfigMap['coskey']['region'], clientConfigMap['coskey']['bucket']);
  }
}
