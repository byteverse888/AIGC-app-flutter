...
class AppNavigator {
  ...
  //added for activity:post and comments
  static void createPost({required Rx<UserInfo> userInfo}) {
    Get.toNamed(AppRoutes.CREATE_POST, arguments: userInfo);
  }

  static void createComment({required Post post}) {
    Get.toNamed(AppRoutes.CREATE_COMMENT, arguments: post);
  }

  static void createAIPost({required Rx<UserInfo> userInfo}) {
    Get.toNamed(AppRoutes.CREATE_AIPOST, arguments: userInfo);
  }

  static void createAIComment({required ParseObject post}) {
    Get.toNamed(AppRoutes.CREATE_AICOMMENT, arguments: post);
  }
}
