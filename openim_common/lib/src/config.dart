...
class Config {
  ...
  static const _host = "service-j81m89sf-1302936021.bj.apigw.tencentcs.com";
  ...
  static String get appAuthUrl {
    ...
    // to c
    return url ??
        (_isIP ? "http://$_host:10008" : "https://$_host/chat_appauth");
  }
  ...
  static String get imApiUrl {
    ...
    return url ?? (_isIP ? 'http://$_host:10002' : "https://$_host/imapi");
  }
